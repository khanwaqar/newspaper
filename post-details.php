               ...
               <!-- End of Navbar toggler -->
						...
						<div id="navbarSupportedContent" class="collapse navbar-collapse navbar-responsive-collapse">
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="category-style2.html"><?php echo $record['category'] ?></a>
								</li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="footer-info-content">
							...
							<p class="footer-info-email"><i class="fa fa-envelope-o"></i> <a href="https://demo.themewinter.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b5d0d1dcc1dac7f5dbd0c2c68781829bd6dad8">[email&#160;protected]</a></p>
