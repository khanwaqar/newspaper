		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<ol class="breadcrumb">
     					<li><a href="#">Home</a></li>
     					<li><?php echo ucfirst($category) ?></li>
     				</ol>
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
			...
			<div class="row">
				<div class="col-lg-8 col-12">
					...
					<div class="block category-listing">
						<h3 class="block-title"><span><?php echo ucfirst($category) ?></span></h3>

						<div class="row">
							<?php 
							$sql = "SELECT * FROM news_articles WHERE `category` = '$category' AND `image_url` != '' ORDER BY `publishedAt` DESC LIMIT 20;";
							...
							<div class="col-md-6">
								<div class="post-block-style post-grid clearfix">
									...
									<div class="post-content">
							 			...
							 			<p><?php echo limit_text($row['description'], 100) ?></p>
